...
const STEPS = [
  {
    ...
    body: "A caseworker types what they already know about a client in plain English — no forms, no dropdowns.",
  },
  {
    title: "Agent builds a profile",
    body: "The Gradient AI intake agent extracts household size, income, and situation into a structured profile.",
  },
  {
    title: "Engine screens, not the AI",
    body: "A tested, deterministic rules engine checks the profile against real SF/CA program thresholds — the model never decides eligibility.",
  },
  {
    title: "Dollars and next steps",
    body: "Get an annual dollar estimate, programs flagged for human review, and a pre-filled application ready to submit.",
  },
];
    ...
    <main className="flex-1 bg-white text-slate-900">
      ...
      <section className="mx-auto flex w-full max-w-4xl flex-col items-center px-6 pt-16 pb-20 text-center sm:pt-20">
        ...
        <h1 className="text-4xl font-semibold tracking-tight text-slate-900 sm:text-5xl md:text-6xl">
          Find every dollar
          <br />
          <span className="text-teal-700">your clients qualify for.</span>
        </h1>

        <p className="mt-6 max-w-2xl text-base text-slate-500 sm:text-lg">
          Describe a client in plain English. Benefy&apos;s intake agent builds a profile, a
          deterministic rules engine screens it against real SF benefit programs, and you get a
          dollar estimate plus a pre-filled application — in minutes, not hours.
        </p>
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              },
              {
                ...
                body: "Uncertain cases are flagged for a caseworker to review, never auto-approved.",
              },
              {
              ...
              },
              {
                ...
                body: "Agent output is checked for over-promising phrasing before a caseworker ever sees it.",
              },
            ].map((item) => (
      ...
      <section className="py-24">
        <div className="mx-auto flex w-full max-w-4xl flex-col items-center gap-6 rounded-2xl bg-teal-700 px-8 py-16 text-center">
          <h2 className="text-3xl font-semibold text-white sm:text-4xl">
            Bring Benefy to your caseload.
          </h2>
          <p className="max-w-xl text-teal-50">
            No database, no auth, no API keys required to try the full demo.
          </p>
          <Link
            href="/"
      ...
      <footer className="border-t border-slate-100 py-10">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-4 px-6 text-sm text-slate-400 sm:flex-row">
          <span>© 2026 Benefy. Built for San Francisco nonprofit caseworkers.</span>
